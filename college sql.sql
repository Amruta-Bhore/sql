...
insert into myDatabase(
      ...
      values (1,'Amruta Bhore','9322054737','F'),
		     (2,'Nikita Kadam','8806172653','F'),
             (3,'Rutuja Sathe ','9844751532','F'),
             (4,'Karan Karanjule','7896541254','M'),
             (5,'Riya Polade','9658745621','F'),
             (6,'Manoj Bhaskar','8957456321','M'),
             (7,'Pooja Kale','9685759171','F'),
             (8,'Kedar Shelar','9685965475','M')
             ;
...
WHERE Name = 'Amruta Bhore' OR PhoneNo = '9322054737';
